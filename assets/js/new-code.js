...
function generateWords(number) {
    ...
    if (number < 20) {
        ...
        word = generateWords(Math.floor(number / ONE_HUNDRED) == 1 ? ' ' : Math.floor(number / ONE_HUNDRED)) + ' yüz';

    } else if (number < ONE_MILLION) {
        remainder = number % ONE_THOUSAND;
        word = generateWords(Math.floor(number / ONE_THOUSAND) == 1 ? ' ' : Math.floor(number / ONE_THOUSAND)) + ' bin';

    } else if (number < ONE_BILLION) {
        remainder = number % ONE_MILLION;
        word = generateWords(Math.floor(number / ONE_MILLION)) + ' milyon';

    } else if (number < ONE_TRILLION) {
        remainder = number % ONE_BILLION;
        word = generateWords(Math.floor(number / ONE_BILLION)) + ' milyar';

    } else if (number < ONE_QUADRILLION) {
        remainder = number % ONE_TRILLION;
        word = generateWords(Math.floor(number / ONE_TRILLION)) + ' trilyon';

    } else if (number <= MAX) {
        remainder = number % ONE_QUADRILLION;
        word = generateWords(Math.floor(number / ONE_QUADRILLION) == 1 ? ' ' : Math.floor(number / ONE_QUADRILLION)) +
            ' kuadrilyon,';
    }
